...
# Versão Final Consolidada – Curva Suave + Cenários + Plotly
# Controles na página / Sidebar livre / Dois eixos / Sem % no gráfico
#############################################################
...
#############################################################
# 4) CONTROLES DO USUÁRIO – NA PÁGINA (NÃO NO SIDEBAR)
#############################################################
...
cenarios = {
    ...
    "Pessimista": min(1.0, participacao_final * 1.3)
}
...
# ==========================================================================
# 1) HISTÓRICO – Apenas se a opção estiver ativa
# ==========================================================================
...
# ==========================================================================
# 2) CENÁRIOS – Também respeitam as opções do usuário
# ==========================================================================
...
for cenario in ["Base", "Otimista", "Pessimista"]:
    ...
    # unir com o último ponto histórico
